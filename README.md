Note: This is a very basic php application, and because of my lack of experience in writing production level php application, I recommend to use this application only as a reference and to search for best practices in php.
